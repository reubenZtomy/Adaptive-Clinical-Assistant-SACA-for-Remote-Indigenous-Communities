...
const onLanguageSelect = useCallback(
    (lang) => {
      try {
        // Save selected language in session storage
        sessionStorage.setItem("saca_language", lang);
      } catch (error) {
        console.error("Error saving language to sessionStorage:", error);
      }

      // Navigate based on language
      if (lang === "english") {
