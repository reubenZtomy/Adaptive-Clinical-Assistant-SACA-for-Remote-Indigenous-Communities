...
const onServiceSelected = (service) => {
  try {
    // Save the selected mode of communication in sessionStorage
    sessionStorage.setItem("saca_mode", service);
  } catch (error) {
    console.error("Error saving mode to sessionStorage:", error);
  }
