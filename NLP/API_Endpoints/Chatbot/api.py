...
app = FastAPI(
    title="SwinSACA Chatbot API",
    description="FastAPI wrapper around the SwinSACA medical triage chatbot. "
                "Use /chat for dialog and /predict to inspect the top intent.",
    version="1.0.0",
)
